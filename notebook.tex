...
\pagestyle{fancy}
\fancyhead[L]{Ohio State University Sublinear Substring Seekers}
\fancyhead[R]{\thepage}
\fancyfoot[C]{}
...
\title{\vspace{-4ex}\Large{Ohio State University ICPC Team Notebook}}
\author{Sublinear Substring Seekers}
\date{}
